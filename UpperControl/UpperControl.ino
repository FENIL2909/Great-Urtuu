...
#define resetAlignButton 47
#define calibrateLSAButton A3

float manualSpeed = 300; 
float xaRED[13] = {0, 30, 75, 110,    160, 225, 260,    340,375,410,450};   
float yaRED[13] = {0, 40, 50,  45,    -40, -55, -50,     55, 60, 55,  0};  


float xaBLUE[13] = {0,15, 75, 110,   190, 225, 265,    315, 375, 430, 450};   
float yaBLUE[13] = {0,50, 60, 55,    -60,-65,-55,       55,  60,  55,   0};  
/*********************************************************************************************************************************************/
/*********************************************************** Wheels **********************************************************************************/
...
enum {afterAlignGobi = 22, reachShagai1, NearTZ, rotateNearTZ1, waitForMR2, TZ1, reachShagai2, TZ2, reachShagai3, TZ3};
...
long int gripperTimeOut = 0, omegaTimeOut;
bool OmFlag = 1;
...
//P D I
  ...
  ppidOmega->initPID(0.155,0.7,0, 0, -2.0, 2.0);            // Kp = 0.12
  ...
  pinMode(resetAlignButton,INPUT_PULLUP);
